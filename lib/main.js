...
exports.simple = exports.SubDomain = exports.Router = exports.Server = exports.JsonReviver = exports.JsonDB = void 0;
// JsonDB
...
// Default export
exports.default = Object.assign((options, httpsMode) => new server_1.default(options, httpsMode), { JsonDB: JsonDB_1.default, JsonReviver: JsonReviver_1.default, Router: router_1.default, SubDomain: subdomain_1.default, simple: simple_1.default });
