    ...
    async invoke(ctx, next) {
        ...
        const __next = async (index, max) => {
            ...
            if (index < max) {
                ...
                await ((_a = this.mds[index + 1]) === null || _a === void 0 ? void 0 : _a.invoke(ctx, async () => __next(index + 1, max)));
            }
        };
        if (ctx.subhost === this.domain)
            // Invoke the middleware
            await ((_a = this.mds[0]) === null || _a === void 0 ? void 0 : _a.invoke(ctx, async () => __next(0, this.mds.length)));
        // End the function
        await next();
    }
}
