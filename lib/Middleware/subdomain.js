        ...
        return __awaiter(this, void 0, void 0, function* () {
            const next = (index, max) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (index < max) {
                    ...
                    yield ((_b = this.mds[index + 1]) === null || _b === void 0 ? void 0 : _b.invoke(ctx, () => __awaiter(this, void 0, void 0, function* () { return next(index + 1, max); })));
                }
            });
            // Invoke the middleware
            yield ((_a = this.mds[0]) === null || _a === void 0 ? void 0 : _a.invoke(ctx, () => __awaiter(this, void 0, void 0, function* () { return next(0, this.mds.length); })));
            if (nxt)
                // End the function
                yield nxt();
        });
