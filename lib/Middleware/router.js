    ...
    async invoke(ctx, next) {
        ...
        const __next = async (index, max) => {
            ...
            if (index < max) {
                ...
                await ((_a = this.middlewares[index + 1]) === null || _a === void 0 ? void 0 : _a.invoke(ctx, async () => __next(index + 1, max)));
            }
        };
        if (ctx.url.startsWith(this.routeName))
            // Invoke the middleware
            await ((_a = this.middlewares[0]) === null || _a === void 0 ? void 0 : _a.invoke(ctx, async () => __next(0, this.middlewares.length)));
        // End the function
        await next();
    }
}
