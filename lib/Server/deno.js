...
function default_1(opts = {}) {
    ...
    return __asyncGenerator(this, arguments, function* () {
        ...
        const server = (opts.httpsMode ? https_1.default : http_1.default)
            ...
            .listen((_a = opts.port) !== null && _a !== void 0 ? _a : 80, (_b = opts.hostname) !== null && _b !== void 0 ? _b : "localhost", (_c = opts.backlog) !== null && _c !== void 0 ? _c : 0), getRequestListener = (result) => ((request, response) => result({ request, response })), getErrorListener = (reject) => ((err) => {
            done = true;
            reject(err);
        });
        while (!done)
