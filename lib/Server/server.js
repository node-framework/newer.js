    ...
    callback() {
        return (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (req.url === "/favicon.ico") {
                ...
                let path = ((_a = this.staticDir) !== null && _a !== void 0 ? _a : ".") + req.url;
        ...
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise(res => {
                this.server = http_1.default
                    ...
                    .listen(port !== null && port !== void 0 ? port : 8080, host !== null && host !== void 0 ? host : "localhost", backlog !== null && backlog !== void 0 ? backlog : 0, () => res(this));
            });
        });
    }
    /**
