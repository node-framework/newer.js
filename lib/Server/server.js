        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                for (var requests_1 = __asyncValues(requests), requests_1_1; requests_1_1 = yield requests_1.next(), !requests_1_1.done;) {
                    ...
                    if (req.url === "/favicon.ico" && !fs_1.default.existsSync(this.iconPath))
                        fs_1.default.appendFileSync(this.iconPath, "");
                    // Next function
                    const next = (index, max) => __awaiter(this, void 0, void 0, function* () {
                        ...
                        if (index < max) {
                            ...
                            yield ((_c = this.mds[index + 1]) === null || _c === void 0 ? void 0 : _c.invoke(c, () => __awaiter(this, void 0, void 0, function* () { return next(index + 1, max); })));
                        }
                    });
                    // Invoke the middleware
                    yield ((_b = this.mds[0]) === null || _b === void 0 ? void 0 : _b.invoke(c, () => __awaiter(this, void 0, void 0, function* () { return next(0, this.mds.length); })));
                    // End the response
