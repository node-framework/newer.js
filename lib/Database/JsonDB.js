...
export default class JsonDB {
     ...
     * @constructor
     */
    constructor(filePaths, reviver = new Reviver()) {
        /**
         * Database data
         */
        ...
        this.schema = (name, schem) => {
            ...
            let sch = (_a = class Schema {
                 ...
                 * @returns the result
                 */
                _a.find = (obj, except = false) => __awaiter(_a, void 0, void 0, function* () { return yield __classPrivateFieldGet(pointer, _JsonDB_find, "f").call(pointer, _a.schem, obj, except); }),
                /**
                 * @param obj to find
                 * @param except if true will find the first object that doesn't match `obj`
                 * @returns the result
                 */
                _a.findOne = (obj, except = false) => __awaiter(_a, void 0, void 0, function* () { return yield __classPrivateFieldGet(pointer, _JsonDB_findOne, "f").call(pointer, _a.schem, obj, except); }),
                /**
                 * Clear the schema
                 */
         ...
         */
        _JsonDB_find.set(this, (schem, obj, except = false) => __awaiter(this, void 0, void 0, function* () {
         ...
         * @returns the first object that is found
         */
        _JsonDB_findOne.set(this, (schem, obj, except = false) => __awaiter(this, void 0, void 0, function* () {
            if (!__classPrivateFieldGet(this, _JsonDB_schemas, "f").map((val) => val.name).includes(schem))
                throw new Error("Invalid schema");
        ...
        __classPrivateFieldSet(this, _JsonDB_filePath, filePaths, "f");
        __classPrivateFieldSet(this, _JsonDB_schemas, [], "f");
        !fs.existsSync(filePaths)
            ? fs.appendFileSync(filePaths, "{}")
            : void 0;
        if (!fs.existsSync(filePaths) || (fs.readFileSync(filePaths).toString() === "{}")) {
            __classPrivateFieldSet(this, _JsonDB_data, {}, "f");
            return this;
        }
        __classPrivateFieldSet(this, _JsonDB_data, JSON.parse(fs.readFileSync(filePaths).toString(), reviver.callback()), "f");
        __classPrivateFieldSet(this, _JsonDB_data, __classPrivateFieldGet(this, _JsonDB_loadSchemas, "f").call(this, JSON.parse(fs.readFileSync(filePaths).toString(), reviver.callback())), "f");
        // Weird thing happens here so I need to fix by using the next line
        fs.writeFileSync(filePaths, JSON.stringify(__classPrivateFieldGet(this, _JsonDB_data, "f"), null, 4));
    }
    /**
     * Returns the current database paths
     */
