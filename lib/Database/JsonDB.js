...
var _JsonDB_loadSchemas, _JsonDB_find, _JsonDB_findOne;
...
export default class JsonDB {
    ...
    constructor(filePath, reviver) {
            ...
            let sch = (_a = class Schema {
                    ...
                    constructor(obj) {
                        ...
                        this.save = () => __awaiter(this, void 0, void 0, function* () {
                            pointer.data[Schema.schem].push(__classPrivateFieldGet(this, _Schema_obj, "f"));
        ...
        this.data = __classPrivateFieldGet(this, _JsonDB_loadSchemas, "f").call(this, JSON.parse(fs.readFileSync(filePath).toString(), reviver));
...
_JsonDB_loadSchemas = new WeakMap(), _JsonDB_find = new WeakMap(), _JsonDB_findOne = new WeakMap();
