    ...
    constructor(filePath, reviver) {
        ...
        this.schema = (name, schem) => {
            ...
            let sch = (_c = class Schema {
                 ...
                 * @returns the result
                 */
                _c.find = async (obj, count, except) => {
                    let listMatch = [];
                    for (let doc of JSON.parse((await pfs.readFile(pth)).toString(), pointer.reviver)[_c.schem]) {
                        // Check if object matches
                        if ((0, ObjectMatch_js_1.default)(obj !== null && obj !== void 0 ? obj : {}, doc) === (!except)) {
                 ...
                 */
                _c.deleteMatch = async (obj, except = false) => {
                 ...
                 */
                _c.drop = async () => await pointer.drop(_c),
                _c);
