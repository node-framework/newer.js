            ...
            let sch = (_a = class Schema {
                    ...
                    constructor(obj) {
                        ...
                        this.update = (obj) => __awaiter(this, void 0, void 0, function* () {
                            ...
                            __classPrivateFieldGet(pointer, _JsonDB_data, "f")[Schema.schem][__classPrivateFieldGet(pointer, _JsonDB_data, "f")[Schema.schem]
                 ...
                 */
                _a.read = () => __awaiter(_a, void 0, void 0, function* () { return JSON.parse((yield pfs.readFile(pth)).toString())[_a.schem]; }),
                /**
                 * @param obj to create
                ...
                _a.update = (obj, updateObj) => __awaiter(_a, void 0, void 0, function* () {
                    const index = __classPrivateFieldGet(pointer, _JsonDB_data, "f")[_a.schem].indexOf(obj);
                    if (!index)
                        throw new Error("Invalid object");
                    __classPrivateFieldGet(pointer, _JsonDB_data, "f")[_a.schem][index] = updateObj;
                    yield pfs.writeFile(pth, JSON.stringify(__classPrivateFieldGet(pointer, _JsonDB_data, "f"), null, 4));
                    return updateObj;
                }),
                /**
